...
2. **내용의 깊이와 분량**:
   ...
   - **정치경제적 상관관계 분석**: 수집된 뉴스 중 국내외 정부 정책, 입법 동향, 지정학적 리스크가 경제 및 산업(특히 반도체, 에너지, 금융 등)에 미칠 파급 효과를 반드시 한 섹션 이상 할당하여 분석하세요.
   - 예: "미국 의회의 보조금 법안 논의가 국내 반도체주의 수급에 미치는 영향" 또는 "한국 금융당국의 밸류업 프로그램 입법 속도가 시장에 주는 신호" 등.
